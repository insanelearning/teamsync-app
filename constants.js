...
export const INITIAL_TEAM_MEMBERS = [
    { id: 'user1', name: 'Alex Manager', email: 'alex@example.com', phoneNumber: '+15551234567', role: TeamMemberRole.Manager, designation: 'Team Lead', internalTeam: 'Engineering', joinDate: '2022-01-15', birthDate: '1990-05-20' },
    { id: 'user2', name: 'Bob Member', email: 'bob@example.com', phoneNumber: '+15557654321', role: TeamMemberRole.Member, designation: 'Sr. Developer', internalTeam: 'Engineering', joinDate: '2022-08-01', birthDate: '1992-11-10' },
    { id: 'user3', name: 'Charlie Member', email: 'charlie@example.com', phoneNumber: '', role: TeamMemberRole.Member, designation: 'QA Engineer', internalTeam: 'QA', joinDate: '2023-03-20', birthDate: '1995-02-25' },
];
